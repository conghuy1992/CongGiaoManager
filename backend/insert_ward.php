...
if (isset($_POST['name']) && isset($_POST['status']) && isset($_POST['id_districts'])&&isset($_POST["user_id"])) {    
    $name = $_POST['name'];
	$status = $_POST['status'];
	...
	"(name, status, id_districts, user_id) VALUES('$name', '$status', '$id_districts', '$user_id')");
