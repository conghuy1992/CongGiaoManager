...
if (isset($_POST['id_church']) 
   ...
   // insert time
	...
	"(id_church, normal_day_morning, normal_day_afternoon, special_day_morning, special_day_afternoon,status) 
    VALUES('$id_church', '$normal_day_morning','$normal_day_afternoon','$special_day_morning','$special_day_afternoon','$status')");
